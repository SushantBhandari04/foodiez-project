        ...
        <motion.div
          ...
          {bookings.length > 0 ? (
            bookings.map((table: Table) => (
              <div key={table.id} className="flex flex-col gap-8  lg:p-6 md:p-5 p-4 w-[460px] bg-gradient-to-br from-sky-950 to-violet-900/80 via-indigo-950  shadow-md md:rounded-lg rounded-md h-fit">
